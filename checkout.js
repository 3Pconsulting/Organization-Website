...
/* 3P SITE-WIDE INTEGRATION V2 — CURRENT WEBSITE VISUAL SYSTEM */
:root{--cream:#132a42;--paper:#08111f;--ink:#e7ecf2;--muted:rgba(231,236,242,.68);--line:rgba(212,160,23,.26)}
body{background:radial-gradient(circle at 90% 0%,rgba(212,160,23,.08),transparent 24%),var(--paper);color:var(--ink)}
.site-header{background:rgba(8,17,31,.97);border-bottom:1px solid rgba(247,215,106,.48)}
.site-nav{gap:17px;font-size:11px}.site-nav a{color:rgba(231,236,242,.70)}.site-nav a:hover{color:var(--gold-light)}
.hero{background:radial-gradient(circle at 82% 10%,rgba(212,160,23,.19),transparent 28%),linear-gradient(145deg,#08111f,#0d1d30)}
.section.cream{background:#132a42}
.product-card,.comparison,.problem-strip a,.process-step,.faq-item,.guarantee,.content-panel,.offer-box,.checkout-card{background:#0d1d30;color:var(--ink)}
.product-card h3,.product-card .price,.content-panel h2,.faq-item h3,.offer-box .price,.checkout-summary h1,label{color:var(--ink)}
.product-card,.comparison,.problem-strip,.faq-item,.content-panel,.checkout-card{border-color:var(--line)}
.problem-strip a{color:var(--ink)}.problem-strip a:hover{background:#132a42;color:var(--gold-light)}
.comparison td{color:var(--ink)}.comparison th{background:#132a42}
.button.secondary{background:transparent;color:var(--gold-light);border-color:var(--gold)}
.button.secondary:hover{background:rgba(212,160,23,.10);color:var(--gold-light)}
.section-head p,.product-card .summary,.timeline,.system-note{color:var(--muted)}
input,textarea,select{background:#071525;color:var(--ink);border-color:rgba(212,160,23,.35)}
input:focus,textarea:focus,select:focus{outline:2px solid var(--gold-light);outline-offset:2px}
.notice{background:rgba(212,160,23,.08);color:var(--ink)}.cta-band{background:var(--gold);color:#071525}.site-footer{background:#071525}
@media(max-width:1120px){.site-nav{gap:12px;font-size:10px}.wordmark img{width:190px}}
